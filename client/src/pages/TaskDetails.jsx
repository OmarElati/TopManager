  ...
  return (
    <div className='w-full flex flex-col gap-3 mb-4 overflow-y-hidden'>
      ...
      <Tabs tabs={TABS} setSelected={setSelected}>
        {selected === 0 ? (
          <>
            <div className='w-full flex flex-col md:flex-row gap-5 2xl:gap-8 bg-white shadow-md p-8 overflow-y-auto rounded-lg'>
              {/* LEFT */}
              <div className='w-full md:w-1/2 space-y-8'>
                ...
                <div className='flex items-center gap-8 p-4 border-y border-gray-200 text-sm'>
                  ...
                  <div className='space-y-3'>
                    {task?.team?.map((m, index) => (
                      ...
                      >
                        <div
                          className={
                            "w-10 h-10 rounded-full text-white flex items-center justify-center text-sm -mr-1 bg-blue-500"
                          }
                        >
    ...
    return (
      <div className='flex space-x-4'>
        ...
        <div className='flex flex-col gap-y-1 mb-8'>
          <p className='text-base font-semibold'>{item?.by?.name}</p>
  ...
  return (
    <div className='w-full flex gap-10 2xl:gap-20 min-h-screen px-10 py-8 bg-white shadow rounded-md justify-between overflow-y-auto'>
      <div className='w-full md:w-1/2'>
        <h4 className='text-gray-600 font-semibold text-base mb-5'>Activities</h4>
      ...
      <div className='w-full md:w-1/3'>
        ...
        <div className='w-full flex flex-wrap gap-5 text-sm'>
